...
namespace Inventarisierung
{
    public class Datenbankverbindung
    {
        ...
        //das void is glaube ich noch falsch.
        public void  createNewUser(string tb_Benutzername, string tb_Kennwort)
        {
            //Verbindungs String bauen
            SqlConnection cnn = new SqlConnection("");
            cnn.ConnectionString = @"Data Source=IF-PC42;
            Initial Catalog=Inventarisierung;
            User id=sa;
            Password=#ifaktor99;";
            cnn.Open();
            ...
            //fehlt glaube ich noch ein teil
